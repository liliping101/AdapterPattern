package com.example.llp.librarycirclemenu;
...
public class CircleMenuLayout extends ViewGroup
{
	...
	*//**
	...
	public static class CircleMenuAdapter extends BaseAdapter {

		List<MenuItem> mMenuItem;

		public CircleMenuAdapter(List<MenuItem> mMenuItem) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			initMenuView(itemView, position);

			return itemView;
		}

		//初始化菜单项
		private void initMenuView(View itemView, int position) {
			//
